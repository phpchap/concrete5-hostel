...
class SlideshowWithCaptionBlockController extends BlockController {
	
	protected $btName = 'Slideshow with Captions';
	protected $btDescription = 'A better slideshow with captions';
	protected $btTable = 'btDCSlideshowWithCaption';
