...
class ImageSliderBlockController extends BlockController {
	...
	protected $btName = 'Image Slider';
	protected $btDescription = 'image slideshow';
	protected $btTable = 'btDCImageSlider';
	...
	public function view() {
		$this->set('field_2_image', (empty($this->field_2_image_fID) ? null : $this->get_image_object($this->field_2_image_fID, 973, 615, true)));
	}
